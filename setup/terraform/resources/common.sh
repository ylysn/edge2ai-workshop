...
EOF
  ...
  # Generate JKS truststore with -storetype JKS, as newer JDK defaults to PKCS12
  # If truststore is PKCS12, ECS installation get stuck at install-cp with error: The truststore is not JKS formatted.
